...
function GeneralCPE() {
    ...
    const courses = ["ECE 1004", "ECE 2024", "ECE 2214", "ECE 2514", "ECE 2544", "ECE 2564", 
        "ECE 2714", "ECE 2804", "ECE 3504", "ECE 3514", "ECE 3544", "ECE 3574", "ECE 4805", 
        "ECE 4806"]; 
    ...
    return( 
        ...
        <table>
                ...
                <tr>
                    <td width="2%"></td>
                    <td width="20%" className="blue">
                        <a href="/classes/ECE2500" class="black" title={courseData[8]}>ECE 3504 Computer Organization and Architecture Pre: 2504 or (2544, 2804)</a>
                    </td>
                    <td width="2%">3</td>
                    <td width="2%" className="black"></td>
                    <td width="2%"></td>
                    <td width="20%" className="blue">CPE Technical Elective from TE list</td>
                    <td width="2%">3</td>
                </tr>
                <tr>
                    <td width="2%"></td>
                    <td width="20%" className="green">
                        <a href="/classes/ECE3514" class="black" title={courseData[9]}>ECE 3514 Data Structure and Algorithms (C-) Pre:1574 or (2514, 2804)</a>
                    </td>
                    <td width="2%">3</td>
                    <td width="2%" className="black"></td>
                    <td width="2%"></td>
                ...
                <tr>
                    <td width="2%"></td>
                    <td width="20%" className="blue">
                        <a href="/classes/ECE3514" className="black" title={courseData[10]}>ECE 3544 Digital Design I Pre: 2504 or (2544, 2804)</a>
                    </td>
                    <td width="2%">4</td>
                    <td width="2%" className="black"></td>
                    <td width="2%"></td>
                ...
                <tr>
                    ...
                    <td width="20%" className="yellow">
                        <a href="/classes/ECE4805" class="black" title={courseData[12]}>ECE 4805 Senior Design Project (C-) See timetable for prereqs</a>
                    </td>
                    <td width="2%">3</td>
                    <td width="2%" className="black"></td>
                    <td width="2%"></td>
                    <td width="20%" className="yellow">
                        <a href="/classes/ECE4806" class="black" title={courseData[13]}>ECE 4806 Senior Design Project Pre: 4805</a>
                    </td>
                    <td width="2%">3</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="2%" className="black"></td>
                    <td width="2%"></td>
                    <td width="20%" className="blue">Pathways 7 or Free Elective (if Pathways 7 double counted)</td>
                    <td width="2%">3</td>
                </tr>
                <tr>
                    <td width="2%"></td>
