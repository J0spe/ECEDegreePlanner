...
/* <table>
            ...
            //             <a href="/classes/ECE1004" class="black"> ECE 1004 Introduction to ECE Concepts (C) Pre: ENGE 1215 or ENGE 1414</a>
            //         </td>
            //         <td width="2%">3</td>
            //     </tr>
            //     <tr>
            ...
            //         <td width="2%"></td>
            //         <td width="20%" className="blue">
            //             <a href="/classes/ECE2214" class="black"> ECE 2214 Physical Electronics (C) Pre: 2024</a>
            //         </td>
            //         <td width="2%">3</td>
            //     </tr>
            //     <tr>
            ...
            //             <a href="/classes/ECE2024" class="black"> ECE 2024 Circuits and Devices (C) Pre: 1004, (MATH 2114 or MATH 2114H or MATH 2405H); Co: 2514, 2544, MATH 2214, PHYS 2306</a>
            //         </td>
            //         <td width="2%">3</td>
            //         <td width="2%" className="black"></td>
            //         <td width="2%"></td>
            //         <td width="20%" className="green">
            //             <a href="/classes/ECE2564" class="black"> ECE 2564 Embedded Systems (C) Pre: 2514, 2544</a>
            //         </td>
            //         <td width="2%">3</td>
            //     </tr>
            //     <tr>
            //         <td width="2%"></td>
            //         <td width="20%" className="green">
            //             <a href="/classes/ECE2514" class="black">ECE 2514 Computational Engineering (C) Pre: 1004; Co: 2024, 2544</a>
            //         </td>
            //         <td width="2%">3</td>
            //         <td width="2%" className="black"></td>
            //         <td width="2%"></td>
            //         <td width="20%" className="blue">
            //             <a href="/classes/ECE2714" class="black">ECE 2714 Signals and Systems(C) Pre: 2024, 2514, 2544; Co: 2564</a>
            //         </td>
            //         <td width="2%">3</td>
            //     </tr>
            //     <tr>
            //         <td width="2%"></td>
            //         <td width="20%" className="green">
            //             <a href="/classes/ECE2544" class="black">ECE 2544 Fundamentals of Digital Systems (C) Pre: 1004, ENGL 1106 or ENGL 1204H; Co: 2024, 2514</a>
            //         </td>
            //         <td width="2%">3</td>
            //         <td width="2%" className="black"></td>
            //         <td width="2%"></td>
            //         <td width="20%" className="green">
            //             <a href="/classes/ECE2804" class="black">ECE 2804 Integrated Design Project (C) Pre: 2024, 2514, 2544; Co: 2214, 2564, 2714</a>
            //         </td>
            //         <td width="2%">2</td>
            //     </tr>
            //     <tr>
            ...
            //         <td width="2%"></td>
            //         <td width="20%" className="blue">
            //             <a href="/classes/ECE2500" class="black">ECE 3504 Computer Organization and Architecture Pre: 2504 or (2544, 2804)</a>
            //         </td>
            //         <td width="2%">3</td>
            //         <td width="2%" className="black"></td>
            //         <td width="2%"></td>
            //         <td width="20%" className="green">
            //             <a href="/classes/ECE3574" class="black">ECE 3574 Applied Software Design (C-) Pre: 2574 or 3514</a>
            //         </td>
            //         <td width="2%">3</td>
            //     </tr>
            //     <tr>
            //         <td width="2%"></td>
            //         <td width="20%" className="green">
            //             <a href="/classes/ECE2574" class="black">ECE 3514 Data Structure and Algorithms (C-) Pre:1574 or (2514, 2804)</a>
            //         </td>
            //         <td width="2%">3</td>
            //         <td width="2%" className="black"></td>
            //         <td width="2%"></td>
            ...
            //             <a href="/classes/ECE4805" class="black">ECE 4805 Senior Design Project (C-) See timetable for prereqs</a>
            //         </td>
            //         <td width="2%">3</td>
            //         <td width="2%" className="black"></td>
            //         <td width="2%"></td>
            //         <td width="20%" className="yellow">
            //             <a href="/classes/ECE4805" class="black">ECE 4806 Senior Design Project Pre: 4805</a>
            //         </td>
            //         <td width="2%">3</td>
            //     </tr>
            //     <tr>
            //         <td width="2%"></td>
            //         <td width="20%" className="blue">
            //             <a href="/classes/ECE4525" class="black">ECE 4525 Video Game Design and Eng Pre: 3574 OR </a>
            //             <a href="/classes/ECE4580" class="black"> ECE 4580 Digital Image Procressing Pre: 2704 or (2714, 2804)</a>
            //         </td>
            //         <td width="2%">3</td>
            //         <td width="2%" className="black"></td>
            //         <td width="2%"></td>
            //         <td width="20%" className="blue">
            //             <a href="/classes/ECE4524" class="black">ECE 4524 Artificial Intelligence and Engineering Applications Pre: (2574 or 3514), STAT 4714</a>
            //         </td>
            //         <td width="2%">4</td>
            //     </tr>
            //     <tr>
            //         <td width="2%"></td>
            //         <td width="20%" className="blue">
            //             <a href="/classes/ECE4524" class="black">ECE 4424 Machine Learning Pre: (2574 or 3514), (STAT 4714 or Stat 4704 or STAT 4705)</a>
            //         </td>
            //         <td width="2%">3</td>
            //         <td width="2%" className="black"></td>
            //         <td width="2%"></td>
            //         <td width="20%" className="blue">
            //             <a href="/classes/ECE4550" class="black">Pathways 2 or 3 or 6a</a>
            //         </td>
            //         <td width="2%">3</td>
            //     </tr>
            //     <tr>
            //         <td width="2%"></td>
            //         <td width="20%" className="blue">
            //             <a href="/classes/ECE4554" class="black">ECE 4554 Introduction to Computer Vision Pre: 3574, (STAT 4714 or Stat 4704 or STAT 4705)</a>
            //         </td>
            //         <td width="2%">3</td>
            //         <td width="2%" className="black"></td>
            //         <td width="2%"></td>
